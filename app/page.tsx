      ...
      <main className="tp-content min-h-screen bg-transparent text-ink">
        ...
        <section id="restitution" className="px-6 py-16 max-w-7xl mx-auto">
          ...
          <p className="text-ash text-sm md:text-base max-w-2xl mb-8 leading-relaxed">
            Take Profit is built around restitution. When a qualifying account loss happens,
            the event is recorded, the failed manager is removed, and the account enters a
            defined restoration path instead of simply disappearing from the system.
          </p>

          <div className="flex flex-wrap items-center gap-3 mb-4">
            <Link href="#screens" className="bg-navy hover:bg-navy-dark text-white text-sm font-semibold px-5 py-3 rounded-md transition-colors">
              Understand restitution
            </Link>
            <Link href="#get-started" className="border border-line bg-white text-sm font-semibold px-5 py-3 rounded-md hover:bg-mist transition-colors">
              Explore the system
            </Link>
          </div>

          <p className="text-xs text-ash">
            Take Profit is not a broker. Your capital remains in an account that belongs to you.
          </p>
        </section>
        ...
        <section className="px-6 pb-16 max-w-7xl mx-auto">
          ...
          <p className="text-sm text-ash mb-8 max-w-xl">
            Most trading products stop at the drawdown. Take Profit shows you what comes next.
          </p>
          ...
          <div className="bg-white border border-line rounded-xl p-6 md:p-8">
            <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-line">
              <div className="pb-6 md:pb-0 md:pr-6">
                ...
                <p className="text-sm text-ash leading-relaxed">At a qualifying drawdown level, the manager is locked out and the event is timestamped automatically.</p>
              </div>
              <div className="pt-6 md:pt-0 md:px-6">
                <p className="text-xs font-bold text-navy mb-1">02. Queue for restoration</p>
                <p className="text-sm text-ash leading-relaxed">The account is placed into a fair, ordered restitution queue.</p>
              </div>
              <div className="pt-6 md:pt-0 md:pl-6">
                <p className="text-xs font-bold text-navy mb-1">03. Keep your place</p>
                <p className="text-sm text-ash leading-relaxed">Stay eligible while you wait. Liquidity support remains available if you need it.</p>
              </div>
            </div>
            <div className="mt-6 pt-6 border-t border-line">
              <p className="text-xs text-ash">
                The core promise of Take Profit is continuity. A qualifying loss becomes a process, not a dead end.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 pb-16 max-w-7xl mx-auto">
          ...
          <p className="text-sm text-ash max-w-2xl leading-relaxed">
            Most prop firms stop at elimination rules. Most brokers stop at execution.
            Take Profit is built around what a trader actually needs after a loss.
            A visible process and a real route back.
          </p>
        </section>
        ...
        <section className="px-6 pb-16 max-w-7xl mx-auto">
          ...
          <div className="bg-white border border-line rounded-xl p-6 md:p-8 grid grid-cols-1 md:grid-cols-5 divide-y md:divide-y-0 md:divide-x divide-line">
            {[
              { n: "01", title: "Qualifying loss", body: "The account crosses the qualifying drawdown level." },
              { n: "02", title: "Automatic lockout", body: "The manager is locked out without waiting for manual review." },
              { n: "03", title: "Queue placement", body: "The event is timestamped and placed in a fair order." },
              { n: "04", title: "Restoration", body: "The account moves through the restoration path." },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-sm text-ash mb-3 leading-relaxed">
                A trader should never have to guess what happens after a loss. The queue shows
                status, eligibility, and the payout path in one place.
              </p>
            ...
            <div>
              ...
              <p className="text-sm text-ash mb-3 leading-relaxed">
                Social Bond liquidity lets traders access value already built inside Take Profit
                without withdrawing and losing momentum, while restitution is being processed.
              </p>
              ...
              <div className="bg-white border border-line rounded-xl overflow-hidden shadow-sm">
                ...
                <div className="p-5">
                  ...
                  <div className="border-t border-line pt-3 text-xs text-ash">
                    Funded by facilitators and bonders on the platform.
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="px-6 pb-16 max-w-7xl mx-auto">
          ...
          <p className="text-sm text-ash mb-8 max-w-2xl leading-relaxed">
            Take Profit is not a broker and does not hold trading deposits. Every traders
            capital remains in their own account. Restitution is subject to eligibility,
            queue status, active use, and the stated risk rules of the system.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="bg-white border border-line rounded-xl p-6">
              ...
              <p className="text-xs text-ash leading-relaxed">Keep your access active by staying logged in regularly.</p>
            </div>
            <div className="bg-white border border-line rounded-xl p-6">
