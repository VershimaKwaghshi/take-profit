...
export async function POST(request: NextRequest) {
  try {
    ...
    const limit = rateLimit(`waitlist:${clientIp}`, 5, 60 * 60 * 1000);
    ...
    // Extract referral code supporting both snake_case and camelCase
    const referredBy = data.referred_by || data.referredBy || null;
